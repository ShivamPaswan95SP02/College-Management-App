...
public class AddTeacher extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items = new String[]{"Select Category","Information Technology",  "Computer Science", "Electrical", "Mechanical","ECE Department","EIE Department","math Department","physics Department","chemistry Department","humanities Department"};
